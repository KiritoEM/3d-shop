...
const AccountPreview: FC<AccountPreviewProps> = ({
    ...
    console.log(image);
    return (
        <div className="account-preview hidden sm:flex w-fit items-center gap-6 rounded-lg border p-5 xl:p-6">
            <Avatar name={name} image={image} className="!size-17" />

            <div className="account-preview__details">
                <h5 className="text-xl xl:text-2xl font-medium">{name}</h5>
